...
<div className="container relative z-10">
    ...
    <img src={logo} alt="" />
        ...
        <div className='  w-fit mx-auto md:m-0'>
            <ul className=''> 
                <li className=' mb-4 '>
                    ...
                    <FaArrowRight className='' /> Home
                    </a>
                </li>
                <li className=' mb-4 '>
                    <a className='flex  items-center gap-2' href="#">
                    <FaArrowRight className='' /> about us
                    </a>
                </li>
                <li className=' mb-4 '>
                    <a className='flex  items-center gap-2' href="#">
                    <FaArrowRight className='' /> contact
                    </a>
                </li>
                <li className=' mb-4 '>
                    <a className='flex  items-center gap-2' href="#">
                    <FaArrowRight className='' /> Specializations
                    </a>
                </li>
            </ul>
        ...
        <div>
        <p className='font-semibold text-center'>El Nasr Building
        511 Giza Square - Giza</p>
    ...
    <p className='text-center bg-blue-950 py-4 border-t-gray-300 border-0 border-t-2'>copyright © 2025 All Rights Reserved <a href="#">NIA Solutions</a></p>
