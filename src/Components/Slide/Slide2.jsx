...
import doctorImg from '../../assets/images/slide2.png'
  ...
  <div>
        ...
        <div className={`flex ${lang == "ar" ? "flex-row-reverse" : ""} `}>
                ...
                <div className={` ${lang == "ar" ? "md:text-right" : "md:text-left"}  w-full md:w-1/2 text-center px-0 py-10  title flex  items-center justify-end  `}>
                            ...
                            <p className='text-sec text-2xl uppercase'>{t("slider2.title")}</p>
                                        <h1 className='text-6xl font-bold my-6 uppercase'>{t("slider2.description")}</h1>
                                        <p className='my-2 text-6xl font-bold uppercase   text-main'>{t("slider2.main")}</p>
